...
<!-- 메인 배너 -->
	...
	<div class="communityworld">
		<ul class="nav nav-pills">
		  ...
		  <li role="presentation" class="active"><a href="<c:url value="/user/community_resume.do"/>#">자소서 첨삭</a></li>
		</ul>
	</div> 
	...
	<div id="pattern" class="pattern">
		<ul class="list">
			...
			<a href="board_interview_detail.html" class="inner">
					<div class="li-img">
						<img src="../img/kakao/resume.png" alt="Image Alt Text" />
					</div>
					<div class="li-text">
						<input type="hidden" value="게시글 번호">
						<h2 class="li-head">제 자소서 봐주세요!</h2>
					</div>
					<div class="li-text2">

    	...
    	<div class="container1">
            ...
            <div class="row">
                <div class="col-half">
                    ...
                    <div class="input-group">
                        <div class="col-third">
                            <input type="text" id="resume-birthY" value="${resumeStandard.birth}" placeholder="YYYY"/>
                        </div>
                        <div class="col-third">
            ...
            <div class="row">
                ...
                <div id="highschool-container">
                    ...
                    <div class="col-half">
                        ...
                        <div class="input-group">
                            <div class="col-third">
                                <input type="text" id="highschool-enterY" placeholder="YYYY" value="${resumeHighschool.highEnterDate}"/>
                            </div>
                            <div class="col-third">
                    ...
                    <div class="col-half">
                        ...
                        <div class="input-group">
                            <div class="col-third">
                                <input type="text" id="highschool-graduY" placeholder="YYYY" value="${resumeHighschool.highGraduDate}"/>
                            </div>
                            <div class="col-third">
                ...
                <div id="college-container">
                    ...
                    <div class="row">
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="college-enterY" placeholder="YYYY" value="${resumeCollege.colEnterDate}"/>
                                </div>
                                <div class="col-third">
                        ...
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="college-graduY" placeholder="YYYY" value="${resumeCollege.colGraduDate}"/>
                                </div>
                                <div class="col-third">
                                ...
                                <div class="col-third">
                                    <select class="select-all" id="college-graduVal">
                                    	<c:choose>
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1003'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003" selected="selected">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1004'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004" selected="selected">재학중</option>
												<option value="status1005">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1005'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005" selected="selected">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1006'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1007'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1008'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005">휴학중</option>
	                                    	...
	                                    	<c:when test="${resumeCollege.colEnterId == 'status1009'}">
			                                    <option value="undefined">선택</option>
			                                    <option value="status1003">졸업</option>
												<option value="status1004">재학중</option>
												<option value="status1005">휴학중</option>

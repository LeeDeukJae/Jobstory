		...
		<div class="jumbotron">
			<div class="home__slider"
				...
				<div class="bxslider">
					...
					<div>
						<img src="../img/kakao/bit1.png" alt="그림2">
					</div>
					<div>
						<img src="../img/kakao/bit2.jpg" alt="그림3">
					</div>
				</div>
			</div>
			...
			<h3 id="company-average">
				...
				<p>
					...
					<a id="companydetailbtn3" class="btn btn-lg btn-primary" 
						href="<c:url value="/main/main_logout_search.do"/>" role="button">근무지 위치</a>
					<a id="companydetailbtn3" class="btn btn-lg btn-primary" 
		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<div class="companymap">
					<div class="addrmap">
						<img src="../img/addr.jpg">
					</div>
					<span id="addrtext">서울시 동작구 사당동 66-4 초원골드 빌라 101호</span>
				</div>
			</div>
		</div>

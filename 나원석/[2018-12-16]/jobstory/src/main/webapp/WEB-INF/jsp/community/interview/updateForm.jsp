...
<div id="content">
	...
	<form method="post" id="frm" enctype="multipart/form-data" action="update.do">
		<div id="board-write">
			<input type="hidden" name="boardNo" value="${board.boardNo}">
		</div>
	<span id="search-img"> </span>
	<div>
		<span>제목:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <input type="text" id="title" name="title" value="${board.title}"/>
		<br><br>
		<span>회사명:&nbsp;</span> <input type="text" id="company" name="company" value="${board.company}" />
	</div>
	<br>
	<div style="width: 210px;">
		<span >면접시기: </span> 
		<select id="search-category" name="applyDate">
		 <c:choose>
		 	<c:when test="${board.applyDate ==1}">
			<option value="1" selected="selected">상반기</option>
			<option value="2">하반기</option>
		 </c:when>
		 	<c:when test="${board.applyDate ==2}">
			<option value="1">상반기</option>
			<option value="2" selected="selected">하반기</option>
		 </c:when>
	...
	<div id="jicjong">
		<span>직종 :</span> 
			...
			<c:choose>
				<c:when test="${board.jobId=='job1001'}">
				...
				<c:when test="${board.jobId=='job1002'}">
				...
				<c:when test="${board.jobId=='job1003'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				...
				<c:when test="${board.jobId=='job1004'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				...
				<c:when test="${board.jobId=='job1005'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1006'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1007'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1008'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1009'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1010'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1011'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1012'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
				...
				<c:when test="${board.jobId=='job1013'}">
				<option value="job1001">경영·사무</option>
				<option value="job1002">유통·무역</option>
				<option value="job1003">영업·고객상담</option>
				<option value="job1004">생산·제조</option>
	...
	<div style="margin-left: 515px;margin-top: -32px;">
		<span>면접 난이도</span> <br>
		<div id="reviewStars-input">
		 <c:choose>
		 	<c:when test="${board.level==1}">
				<input id="star-2" type="radio" name="level" value="3" /> <label
				title="regular" for="star-2"></label>
				
				<input id="star-1"
				type="radio" name="level" value="2" /> <label
				title="poor" for="star-1"></label>
				
				<input id="star-0" type="radio"
				name="level" value="1"  checked="checked"/> <label title="bad" for="star-0"></label>
		 	</c:when>
		 	...
		 	<c:when test="${board.level==2}">
				...
				<input id="star-1"
				type="radio" name="level" value="2"  checked="checked" /> <label
				title="poor" for="star-1"></label>
				
				<input id="star-0" type="radio"
				name="level" value="1"/> <label title="bad" for="star-0"></label>
		 	</c:when>
		 	
		 	<c:when test="${board.level==3}">
				<input id="star-2" type="radio" name="level" value="3"  checked="checked" /> <label
				title="regular" for="star-2"></label>
	...
	<div class="file-attach">
		<br>
		<span>면접 회사</span> <input type="file" id="file-attach" name="attach"
			multiple="multiple" />
	</div>
	<div class="col-half">
	...
	<textarea name="content" id="smarteditor" rows="10" cols="100" style="width: 766px; height: 412px;">${board.content}</textarea>
	<br>
	<div id="writebtn">
		<input type="button" class="btn btn-warning" role="button" id="savebutton" value="등록" />
		<a href="list.do"><button type="button" class="btn btn-warning" role="button">목록으로</button></a>
	</div>
</form>

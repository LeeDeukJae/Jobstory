...
$(function () {
    ...
    ws.onmessage = function(evt) {
    	if(evt.data.split(":")[0]=="${user.id}"){
    		$(".msg-bubble1 > .msg-info > .msg-info-name1").text("나");
        	$(".msg-bubble1 > .msg-text1").text(evt.data.split(":")[1]);
    		
    	} else {
    		console.log(evt.data.split(":")[0]=="${user.id}")
    		console.log("${user.id}")
    		console.log(evt.data.split(":")[0])
    		$(".msg-text").prepend(evt.data.split(":")[1] + "<br>");
    	}
    };

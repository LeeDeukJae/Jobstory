                    ...
                    <div class="login__form">
                      ...
                      <div style="margin-bottom:10px;margin-top:-10px">
                          <div id="naverIdLogin" style="display:none"></div>
                            ...
                            <img id="naver" src="../img/네이버 아이디로 로그인_아이콘형_White.PNG" width="50px;" >
                            </a>
                            <a id="custom-login-btn" href="javascript:loginWithKakao()">
                            <img id="kakao" src="../img/카카오.png" width="50px;" style="margin-left:5px;border-radius: 10%">
                            </a>
                            <a id="kakao-login-btn"></a>
                      </div>
                     
                      <p class="login__signup">Don't have an account? &nbsp;<a href="./main_sign up.html">Sign up</a></p>
                    </div>
                  </div>      
                </div>
              </div>
                ...
                success: function (authObj) { 
                    ...
                    success: function(res) {
                    	...
                    	location.href='kakao.do?id='+res.id+
        		 		...
        		 		'&pass=1234'+
        		 		'&authority='+1+
        		 		'&imgSerPath='+ res.properties['profile_image']+
        		 		'&imgOriName=null'+
        		 		'&imgSerName=null'
...
var naverLogin = new naver.LoginWithNaverId(
			{
				...
				callbackUrl: "http://127.0.0.1:5500/qna.html",
				isPopup: false,
        callbackHandle: true,

        ...
        <div class="cont_forms" >
         ...
         <div class="cont_form_login">
           ...
           <div>
              ...
              <a id="btn-upload"><img src="../img/admin.jpg" class='userpic' alt=""></a>    
          </div>
           <input type="text" placeholder="Id" name="id" id="userId"/>
                ...
                <div class="center" style="margin-left: 100px; padding-bottom:42px; width: 100px;height: 30px; ">
                        <label class="label">
                          <input  class="label__checkbox" type="checkbox" value=1 />
        ...
        <button class="btn_user" onclick="user()">SIGN UP</button>
           ...
           <div class="cont_form_sign_up">
             ...
             <div>
              ...
              <a id="btn-upload2"><img src="../img/admin.jpg" class='userpic' alt=""></a>    
          </div>
...
$(".label__checkbox").click(function () {
    if($(this).val()=="1") { // 체크후의 값이 널 이라면 체크
        $(".label__checkbox").attr("checked", true);  
        swal(
            '승인완료!',
            '사용가능한 아이디 입니다!',
            'success'
        ...
        $(".label__checkbox").attr("checked", false);

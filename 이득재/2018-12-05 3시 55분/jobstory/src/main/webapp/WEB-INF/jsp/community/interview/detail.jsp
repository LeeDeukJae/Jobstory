        ...
        <div id="contents">
          ...
          <p>
           ${board.content}
            ...
            <img src="http://img.jobkorea.co.kr/images/ContentsManagement/SmartEditor/2018/11/2018112015825_SEU.jpg"/>
            (사진=잡코리아)
            ...
            <div id="contentside">
                    <span>조회수: <img src="../img/view.png" id="viewicon"> ${board.viewCnt} </span> <span id="rc">추천수: 152 </span> 
            </div>
                                  <div id="siren">

    ...
    <div class="all-container">
        ...
        <div class="list-container">
            <div class="title-container">
                ...
                <span id="resume-list-count" class="list-count">총 <span>${rCnt}</span> 건</span>
        ...
        <div class="attach-container">
            <div class="title-container">
                ...
                <span id="attach-list-count" class="list-count">총 <span>${attachCnt}</span> 건</span>
    ...
    <script>
      ...
      /* [첨부파일] */
        ...
        $("#resume-btn").click(function () {
           var rCnt = $("#resume-list-count > span").text();
           console.log("cnt : " + rCnt);
           if(rCnt < 10){
        ...
        $("#delete-btn").click(function () {
           ...
           $.ajax({
            ...
            $("#resume-list-count").html("총 <span>" + cnt + "</span> 건");

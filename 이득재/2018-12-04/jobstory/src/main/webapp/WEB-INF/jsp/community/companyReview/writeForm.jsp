...
//     document.forms['frm']['id'].value = "$(this).parent().parent().data('index')";
	...
	//console.log("score1의 input val : ", inputScore2);
	//console.log("score1의 input val : ", inputScore3);
	//console.log("score1의 input val : ", inputScore4);
	//console.log("score1의 input val : ", inputScore5);
  })
  // 별 한개 클릭시
  $('.full').click(function() {
    if (starClicked == true) {

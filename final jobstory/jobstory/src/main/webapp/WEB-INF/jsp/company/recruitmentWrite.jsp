          ...
          <div class="row">
              <div class="col-half">
                  ...
                  <div class="input-icon" id="resume-photo-container">
                      <img src="../profile/Penguins.jpg" id="profile"/>
                  </div>
        ...
        <div class="container2">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-half">
                        <div class="input-group">
        			<input  style="display:none" placeholder="우편번호" name="addr1" id="addr1" type="text" >
            		<input  style="display:none" placeholder="도로명 주소" name="addr2" id="addr2" type="text"/>
            		<button type="button" class="btn btn-default" onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
                      
                      <input style="margin-top:20%;width:480px"type="text" name="addr3" placeholder="상세 주소를 입력하세요"/>
                        </div>
                    </div>
                    <div class="col-half">
                        <div class="input-group">

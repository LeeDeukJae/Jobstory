...
<body>
    ...
    <!-- 메인 -->
        ...
        <div class="container2">
            <div class="row">
                <div class="row" id="edu-container">
	                <h4>학력사항</h4>
	                <span>학력</span>
	                <div class="input-group">
                ...
                <div id="highschool-container">
                    ...
                    <div class="col-half">
                        ...
                        <div class="input-group">
                            <div class="col-third">
                                <input type="text" id="highschool-enterY" maxlength="4" placeholder="YYYY"/>
                            </div>
                            <div class="col-third">
                                <input type="text" id="highschool-enterM" maxlength="2" placeholder="MM"/>
                            </div>
                            <div class="col-third">
                    ...
                    <div class="col-half">
                        ...
                        <div class="input-group">
                            <div class="col-third">
                                <input type="text" id="highschool-graduY" maxlength="4" placeholder="YYYY"/>
                            </div>
                            <div class="col-third">
                                <input type="text" id="highschool-graduM" maxlength="2" placeholder="MM"/>
                            </div>
                            <div class="col-third">
                ...
                <div id="college-container">
                    ...
                    <div class="row">
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="college-enterY" maxlength="4" placeholder="YYYY"/>
                                </div>
                                <div class="col-third">
                                    <input type="text" id="college-enterM" maxlength="2" placeholder="MM"/>
                                </div>
                                <div class="col-third">
                        ...
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="college-graduY" maxlength="4" placeholder="YYYY"/>
                                </div>
                                <div class="col-third">
                                    <input type="text" id="college-graduM" maxlength="2" placeholder="MM"/>
                                </div>
                                <div class="col-third">
                ...
                <div class="career-container">
                    ...
                    <div class="row">
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="company-joinY" maxlength="4" placeholder="YYYY"/>
                                </div>
                                <div class="col-third">
                                    <input type="text" id="company-joinM" maxlength="2" placeholder="MM"/>
                                </div> 
                            </div>
                        </div>
                        <div class="col-half">
                            ...
                            <div class="input-group">
                                <div class="col-third">
                                    <input type="text" id="company-resignY" maxlength="4" placeholder="YYYY"/>
                                </div>
                                <div class="col-third">
                                    <input type="text" id="company-resignM" maxlength="2" placeholder="MM"/>
                                </div>
                                <div class="col-third">
        			...
        			url : "resumeWrite.do",
         			...
         			beforeSend: function () {
						if(title == ""){
							...
							noneAction('주소를 입력해주세요',"#resume-addr");
						} else if (detailAddr == "") {
							noneAction('상세 주소를 선택해주세요',"#resume-detail-addr");
						} else if (jobStatus == undefined) {
							noneAction('구직 상태를 선택해주세요',"#job-status");
						} else if (career == undefined) {
							noneAction('경력 항목을 선택해주세요',"input[name=experience]:checked");
						} else if (agree  == undefined) {
							noneAction('개인정보 취급 관련 항목에 동의 해주세요',"input[id=terms]:checked");
						} else if (publicPrivate == undefined) {
							noneAction('이력서 공개 여부를 해주세요',"input[name=resume-public]:checked");
						} else if (edu == undefined) {
							noneAction('학력을 선택 해주세요',"#education-field");
						} else if (edu == undefined) {
							noneAction('학력을 선택 해주세요',"#education-field");
						};
						...
						if(career == 'exper1001'){
							switch (edu){
								...
								case "educa1001":
									if(highName == "") {
										noneAction('고등학교명을 입력해주세요',"#highschool-name");
									} else if (highMajor == "undefined") {
										noneAction('전공계열을 선택해주세요',"#highschool-major");
									} else if (highLocation == "undefined") {
										noneAction('지역을 선택해주세요',"#highschool-location");
									} else if (highEnterY.length < 4) {
										noneAction('입학년월을 올바르게 입력해주세요',"#highschool-enterY");
									} else if (highEnterM.length < 2) {
										noneAction('입학년월을 올바르게 입력해주세요',"#highschool-enterM");
									} else if (highEnterVal == "undefined") {
										noneAction('입학 구분을 선택해주세요',"#highschool-enterVal");
									} else if (highGraduY.length < 4) {
										noneAction('졸업년월을 올바르게 입력해주세요',"#highschool-graduY");
									} else if (highGraduM.length < 2) {
										noneAction('졸업년월을 올바르게 입력해주세요',"#highschool-graduM");
									} else if (highGraduVal == "undefined") {
										noneAction('졸업 구분을 선택해주세요',"#highschool-graduVal");
									}
									break;
								/* 대학교 졸업*/
								case "educa1003":
									if(colDayNight == "") {
										noneAction('고등학교명을 입력해주세요',"#college-dayNight");
									} else if (highMajor == "undefined") {
										noneAction('전공계열을 선택해주세요',"#highschool-major");
									} else if (highLocation == "undefined") {
										noneAction('지역을 선택해주세요',"#highschool-location");
										...
										noneAction('졸업 구분을 선택해주세요',"#highschool-graduVal");
									} else if (colDayNight == "undefined") {
										noneAction('[대학교 주간/야간] 을 선택해주세요',"#college-dayNight");
									} else if (colVal == "undefined") {
										noneAction('[대학교 구분] 을 선택해주세요',"#college-val");
									} else if (colName == "") {
										noneAction('[대학교 명] 을 입력해주세요',"#college-name");
									} else if (colLocation  == "") {
										noneAction('[대학교 지역] 을 선택해주세요',"#college-location");
									} else if (colMajor == "") {
										noneAction('[대학교 주전공] 을 입력해주세요',"#college-major");
									} else if (colMajorField == "undefined") {
										noneAction('[대학교 주전공 구분] 을 입력해주세요',"#college-major-field");
									} else if (colSubMajor == "") {
										noneAction('[대학교 부전공] 을 입력해주세요',"#college-sub-major");
									} else if (colSubMajorField == "undefined") {
										noneAction('[대학교 부전공 구분] 을 입력해주세요',"#college-sub-major-field");
									} else if (colEnterY.length < 4) {
										noneAction('[대학교 입학년월] 을 올바르게 입력해주세요',"#college-enterY");
									} else if (colEnterM.length < 2) {
										noneAction('[대학교 입학년월] 을 올바르게 입력해주세요',"#college-colEnterM");
									} else if (colEnterVal == "undefined") {
										noneAction('[대학교 입학 구분] 을 선택해주세요',"#college-enterVal");
									} else if (colGraduY.length < 4) {
										noneAction('[대학교 졸업년월] 을 올바르게 입력해주세요',"#college-graduY");
									} else if (colGraduM.length < 2) {
										noneAction('[대학교 졸업년월]을 올바르게 입력해주세요',"#college-graduM");
									} else if (colGraduVal == "undefined") {
										noneAction('[대학교 졸업 구분]을 선택해주세요',"#college-graduVal");
									} else if (colAvgGrade == "") {
										noneAction('[대학교 평균 학점]을 입력해주세요',"#college-Avg-grade");
									} else if (colStandGrade == "undefined") {
										noneAction('[대학교 기준 학점]을 입력해주세요',"#college-standard-grade");
									}
									break;
								/* 석 박사 졸업 */
								case "educa1004":
							...
							switch(edu){
								case "educa1001":
									...
									/* 경력항목  */
										...
										noneAction('[회사명] 을 입력해주세요',"#company-name");
									} else if (compJoinY < 4) {
										noneAction('[입사년월] 을 입력해주세요',"#company-joinY");
									} else if (compJoinM < 2) {
										noneAction('[입사년월] 을 입력해주세요',"#company-joinM");
									} else if (compResignY < 4) {
										noneAction('[퇴사년월] 을 입력해주세요',"#company-resignY");
									} else if (compResignM < 2) {
										noneAction('[퇴사년월] 을 입력해주세요',"#company-resignM");
									} else if (compStatus == "undefined") {
										noneAction('[재직 및 퇴사 구분] 을 입력해주세요',"#company-status");
									} else if (compLocation == "undefined") {
										noneAction('[근무 지역] 을 입력해주세요',"#company-location");
									} else if (compDep == "") {
										noneAction('[근무 부서] 를 입력해주세요',"#company-department");
									} else if (compSalary == "") {
										noneAction('[연봉] 을 입력해주세요',"#company-salary");
									} else if (resignReason == "undefined") {
										noneAction('[퇴사 사유] 를 입력해주세요',"#resign-reason");
									} else if (compPosition == "") {
										noneAction('[직급] 을 입력해주세요',"#company-position");
									} else if (compJobField == "undefined") {
										noneAction('[업종] 을 입력해주세요',"#company-job-field");
									}
									break;
								/* 대학교 졸업*/
								case "educa1003":

...
// //   		console.log("달력 : " + "${year}" + "${month}");
// 		var target = $("td[bgcolor]").data("val"); // 오늘 날짜 값
// // 		var search = "${year}" + "${month}"; // 오늘 년월
		
// 		var list = '${calendarCheck}';
// 		 var arrayList = new Array('${calendarCheck}');
// 		 console.log(list);
// 		 console.log(arrayList);
		 
// 		 var json = JSON.parse('${calendarCheck}');

// 		 console.log(json);

// // 		console.log("데이터 : " + "${calendarCheck}");
// // 		for (var i = 0; i < calendarDate.length; i++ ){
// // 			console.log(calendarDate[i]);
// // 		}
		
// 		target = target.toString();
// 		check = target.substring(0, 6);
		
// 		console.log(target);

// // 		console.log("서치" + search);
//   		if(calendarDate.indexOf(check)) {
//   			console.log("찾음");
//   		}
//   	});    
      ...
      $(function() {
    	  ...
    	  var date = $("td[bgcolor]").data("val");
		   ...
		   for (let key of keyArray) {
			   $("td[data-val='"+key+"']").append("<span class='glyphicon glyphicon-ok' aria-hidden='true'></span>")
		   }
...
//     			   		 + '<button type="button" id="deleteContent" value="' + dataList[i].memoNo + '">삭제</button>';
  ...
  <script>
//   for(var i=0; i<$("td[data-val]").length; i++){
// 	  //console.log($("td[data-val]")[i].dataset.val)
	
// // 	  $("td[data-val]").removeClass("date--choice");
// 	  var data1 =$("td[data-val]")[i]
...
// 		  url : "<c:url value='/user/detailCalendar.do'/>",
// 		  data : {
// 			   calendarDate : $("td[data-val]")[i].dataset.val,
// 			   memberNo : "${user.memberNo}"
// 			   }
// 		}).done(function(list) {

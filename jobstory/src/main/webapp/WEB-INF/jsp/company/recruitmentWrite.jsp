...
/* 			border: 1px solid black; */
  ...
  <body>
    ...
    <!--팀원들 적용 에어리어-->
    <!--공고 등록-->
    <form id="formSub"action="regist.do" method="post" enctype="multipart/form-data">  
        <div class="container1">
          ...
          <div class="row">
              ...
              <div class="input-group">
                  <input type="text" name="title" placeholder="0자~20자"/>
              </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-half">
                  ...
                  <div class="input-group input-group-icon">
                      <input type="email" name="email" placeholder="담당자 Email"/>
                      <div class="input-icon"><i class="fa fa-envelope"></i></div>
                  </div>
                  <div class="input-group input-group-icon">
                      <input type="text" name="phone" placeholder="기업 대표전화"/>
                ...
                <div class="row">
                    <div class="input-group">
                        <select class="select-all" name="jobId">
        ...
        <div class="container2">
            <div class="row">
                ...
                <div class="col-half">
                  ...
                  <div class="input-group">
                	<input type="text" name="staffCnt" placeholder="예) 2명" style="width: 51%"/> 
                ...
                <div class="input-group">
                    <input type="textarea" name="license" placeholder="예) 운전면허증, 정보처리기사, 한자자격증"/>
                </div>
                <hr style="opacity:0.3;">    
                <div class="row">
                    <h4>성별</h4>
                ...
                <div class="row">
        			...
        			<input style="width:480px ;margin-top:10%"placeholder="우편번호" name="addr1" id="addr1" type="text" >
            		<input style="width:480px" placeholder="도로명 주소" name="addr2" id="addr2" type="text"/>
                      
                      <input style="margin-top:10%;width:480px"type="text" name="addr3" placeholder="상세 주소를 입력하세요"/>
                        </div>
                    </div>
                    <div class="col-half">
                        <div class="input-group">
                ...
                <div class="row">
                    <div class="input-group">
                        ...
                        <div class="col-half">
                            <input type="button" name="cancel" value="뒤로가기" id="cancel" onclick="history.back();"/>
                        </div>
                    </div>
                </div>
            <!-- container2 마지막 태그 -->

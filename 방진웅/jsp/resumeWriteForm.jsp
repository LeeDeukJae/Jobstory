                ...
                <div class="career-container">
                    ...
                    <div class="row">
                        <div class="col-half">
                            <div class="input-group">
                                <span>연봉</span>
                                <input type="text" name="payment" id="company-salary" placeholder="만원" value="만원">
                            </div>
                        </div>
                        <div class="col-half">
                            <span>퇴사 사유</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-half">
                            <div class="input-group">
                                <span>연(년)차</span>
                                <input type="text" name="payment" id="company-year" placeholder="년">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
// 				var form = $("#resumeForm")[0];
				...
				formData.append("compStatus", compStatus);
				formData.append("compLocation", compLocation);
				...
				formData.append("compYear", compYear);
				formData.append("compJobField", compJobField);
				formData.append("compTotalY", compTotalY);
				formData.append("compTotalM", compTotalM);

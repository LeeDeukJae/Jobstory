        ...
        <div class='card'>
          ...
          <c:if test="${a.fnp eq 'w'}">
          	...
          	<c:if test="${a.fnp eq 'p'}">
          		<img id="cardImg" alt='' src='../img/pass.png'>

          	</c:if>
          	<c:if test="${a.fnp eq 'f'}">
          		<img id="cardImg" alt='' src='../img/fail.png'>
          	</c:if>
          ...
          <div class="card-btn">
              <a href='<c:url value="/company/detail.do?recruitmentNo=${a.recruitmentNo}&name=${a.recruitment.name}"/>'><button type="button" class="btn btn-primary">공고보기</button></a>
              <a href='<c:url value="delete.do?&applyNo=${a.applyNo}"/>'><button type="button" class="btn btn-danger">삭제하기</button></a>
          </div>
      </div>
    </div>

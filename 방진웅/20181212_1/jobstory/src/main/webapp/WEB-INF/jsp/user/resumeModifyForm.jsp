            ...
            <div class="row">
                ...
                <c:choose>
	                <c:when test="${resumeStandard.statusId == 'status1010'}">
	                    <input type="radio" name="statusId" value="status1010" id="student" checked/>
	                    <label for="student"><span><i class="fa fa-pencil-square"></i>구직준비중</span></label>
	                    <input type="radio" name="statusId" value="status1011" id="none-job"/>
	                    <label for="none-job"> <span><i class="fa fa-location-arrow"></i>구직중</span></label>
	                    <input type="radio" name="statusId" value="status1012" id="job"/>
	                    <label for="job"> <span><i class="fa fa-paste"></i>재직중</span></label>
	                </c:when>
	                <c:when test="${resumeStandard.statusId == 'status1011'}">
	                    <input type="radio" name="statusId" value="status1010" id="student" />
	                    <label for="student"><span><i class="fa fa-pencil-square"></i>구직준비중</span></label>
	                    <input type="radio" name="statusId" value="status1011" id="none-job" checked/>
	                    <label for="none-job"> <span><i class="fa fa-location-arrow"></i>구직중</span></label>
	                    <input type="radio" name="statusId" value="status1012" id="job"/>
	                    <label for="job"> <span><i class="fa fa-paste"></i>재직중</span></label>
	                </c:when>
	                <c:when test="${resumeStandard.statusId == 'status1012'}">
	                    ...
	                    <input type="radio" name="statusId" value="status1011" id="none-job"/>
	                    <label for="none-job"> <span><i class="fa fa-location-arrow"></i>구직중</span></label>
	                    <input type="radio" name="statusId" value="status1012" id="job" checked/>
	                    <label for="job"> <span><i class="fa fa-paste"></i>재직중</span></label>
	                </c:when>
                </c:choose>
                </div>
...
<!--             </div>  -->
	                    ...
	                    <div class="row">
	                        <div class="col-half">
	                            <div class="input-group">
	                                ...
	                                <input type="text" id="college-sub-major" placeholder="전공학과" value="${resumeCollege.colSubMajor}"/>
	                            </div>
	                        </div>
	                        <div class="col-half">
	                            <div class="input-group">
        ...
        <script>
        	...
        	$("#submit").click(function (e) {
        		...
        		var jobStatus =	$("input[name=statusId]:checked").val();
...
// 				/* 경력사항 */
        		...
        		$.ajax({
        			url : "resumeModify.do?resumeNo=${resumeStandard.resumeNo}",
         			type : "POST",
         			data : formData,
         			processData: false,
         			contentType: false,

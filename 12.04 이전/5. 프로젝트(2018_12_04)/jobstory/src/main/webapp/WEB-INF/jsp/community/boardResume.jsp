      ...
      <ul class="list" style="padding-left: 30%; padding-top:80px;">
         <c:forEach var="Resume" items="${list}">
            <li>
                <a href="#" class="inner">
                    <div class="li-text">
                        <input type="hidden" value="${Resume.boardNo}">
                        <h2 class="li-head">${Resume.title}</h2>
                          <p class="dd"><img src="../img/view.png" id="viewicon"/> ${Resume.viewCnt}</p>
                            <p class="dd">작성일: <fmt:formatDate value="${Resume.regDate}"
							pattern="yyyy-MM-dd" /></p><br>
                            <p class="dd">작성자:${Resume.writer}</p>
                       </div>
                  </a>
            </li>
          </c:forEach>
              ...
              <div class="writebutton">
                <button><a href="../11 smart/smarteditor2-2.8.2.3/resumeWrite.html">글쓰기</a></button>
              </div>
        </ul>
    </div>
